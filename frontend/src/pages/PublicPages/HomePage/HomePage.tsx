...
import flow from '../../../assets/img/Flow.jpeg';
  ...
  return (
    ...
    <main className="flex min-h-full flex-col m-15 items-center">
      ...
      <div className="grid grid-cols-first-block pt-12 w-1242">
        ...
        <img  className=' w-555 pl-2 pt-6' src={landingPage} width={544} height={531} alt='dashboard image'/>
      </div>
      ...
      <div className=" grid grid-cols-3 gap-12 my-24 sm:flex sm:flex-col ">
        <div className="flex flex-col max-w-xs gap-1">
          ...
          <p>Ve los <Link className="text-green underline underline-offset-2" to='/pricing'>planes</Link> que tenemos para ti y elige el que mejor se ajuste a tus necesidades.</p>
        </div>
