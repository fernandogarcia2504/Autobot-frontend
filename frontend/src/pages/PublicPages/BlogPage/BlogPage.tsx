...
import BlogCard from "../../../components/cards/PublicCards/BlogCard/BlogCard";
...
const Blog = () => {
    return (
        <div>
            <HomeNav />
            <div className="flex flex-col items-center pt-14 gap-20 justify-center ">
                ...
                <div className="flex flex-row flex-wrap items-center justify-center w-4/6">
