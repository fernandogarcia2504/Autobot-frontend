            ...
            <div className="border shadow-2xl rounded-lg flex flex-col pt-12 pb-12 px-5 max-w-sm">
                <form>
                    <div className="grid grid-rows-5 gap-5">
                        ...
                        <input className="border border-black rounded-md place" type="text" name="email" id="email" placeholder="  Correo o nombre de usuario" />
                        <input className="border border-black rounded-md " type="password" name="password" id="password" placeholder="  Contraseña" />
